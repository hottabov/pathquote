...
export default async function IndustriesPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Industries"
        description="The shared list every client card picks from. Renaming one changes it on every company that uses it, and on the order forms that print it. Aliases record the other spellings — ACT!'s wording, or a typo — that should find the same row."
      />
